...
public class RedirectionManager : MonoBehaviour {
    ...
    public void UpdateRedirector(System.Type redirector)
    {
        RemoveRedirector();
        this.gameObject.AddComponent(redirector);
        this.redirector = this.gameObject.GetComponent<Redirector>();
        SetReferenceForRedirector();
    }
    ...
    public void UpdateResetter(System.Type resetter)
    {
        RemoveResetter();
        if (resetter != null)
        {
            this.gameObject.AddComponent(resetter);
            this.resetter = this.gameObject.GetComponent<Resetter>();
            SetReferenceForResetter();
            if (this.resetter != null)
