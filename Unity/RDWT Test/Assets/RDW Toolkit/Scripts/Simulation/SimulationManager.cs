    ...
    public void Initialize()
    {
        ...
        */
        ...
        if (redirectionManager.runInTestMode)
        {
            ...
            PathSeedChoice pathSeedChoice = PathSeedChoice.Office;
            ...
            {
                case 1:
                    setUpExperimentTrackingAreaSizePerformance(pathSeedChoice, redirectorType, resetterType);
                    break;
                case 2:
                    setUpExperimentTrackingAreaShape(pathSeedChoice, redirectorType, resetterType);
                    break;
                //case 3:
